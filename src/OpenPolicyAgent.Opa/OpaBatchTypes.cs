...
public static class DictionaryExtensions
{
    ...
    public static OpaBatchErrors ToOpaBatchErrors(this Dictionary<string, OpenPolicyAgent.Opa.OpenApi.Models.Errors.ServerError> errors)
    {
    ...
    public static OpaBatchErrors ToOpaBatchErrors(this Dictionary<string, OpenPolicyAgent.Opa.OpenApi.Models.Components.ServerErrorWithStatusCode> errors)
    {
        var opaBatchErrors = new OpaBatchErrors(errors.Count);
        foreach (var kvp in errors)
        {
    ...
    public static OpaBatchErrors ToOpaBatchErrors(this Dictionary<string, OpenPolicyAgent.Opa.OpenApi.Models.Components.ServerError> errors)
    {
        var opaBatchErrors = new OpaBatchErrors(errors.Count);
        foreach (var kvp in errors)
        {
